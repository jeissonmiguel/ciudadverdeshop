...
if(!empty($_SESSION["id"])){
 ...
 $busqueda="SELECT * FROM registrotienda WHERE numRegistroTienda=$id";
   ...
   echo "<script type='text/javascript'>window.location='interfazcliente.php?id=".$tienda."'</script>";}

   if(!empty($empresa)){ 
   	echo $empresa;
    echo "<script type='text/javascript'>window.location='interfazcliente.php?id=".$empresa."'</script>";}

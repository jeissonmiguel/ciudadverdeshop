<div id="modolista" name="modolista" class="letrat">
<?php if(!empty($tienda)){ echo '<div id="hd3" name="hd3" class="col-12 tamaño badge badge-success btn btn-success letrat1"><h2>Estos son los productos registrados en <b>'; if(!empty($tienda)){ echo $tienda; } if(!empty($empresa)){ echo $empresa; }echo'</b> selecciona para editar</h2></div>';} if(!empty($empresa)){ echo '<div id="hd3" name="hd3" class="col-12 tamaño badge badge-info btn btn-info letrat1"><h2>Estos son los productos registrados en <b>';if(!empty($tienda)){ echo $tienda; } if(!empty($empresa)){ echo $empresa; }echo'</b> selecciona para editar</h2></div> '; }?>

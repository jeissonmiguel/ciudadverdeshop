  ...
  <?php  
   if(!empty($numregistroempresa)){
    if ($numregistroempresa!="") {
        echo '<div id="hd3" name="hd3" class="col-12 btn btn-info border border-dark"><h2 class="letrat1 text-white">Estas en la Empresa <b>'; if(!empty($tienda)){ echo $tienda; } if(!empty($empresa)){ echo $empresa; } echo '</b> disfruta de sus productos</h2></div>';
     // include ("../conexion/conexion.php");
     ...
     // $nombre1 = mysqli_query($conexion,$busqueda1);
         ...
         while($row = mysqli_fetch_row($nombre)){         
          echo "<header><div class='col-12 float-left badge badge-info'><!-- <h5>Licor</h5> -->
            <img src='../crearTienda/$row[36]' style='width:50%; height:300px;'  onmouseout='this.style.opacity=1;this.filters.alpha.opacity='100';' onmouseover='this.style.opacity=0.7;this.filters.alpha.opacity='20';>

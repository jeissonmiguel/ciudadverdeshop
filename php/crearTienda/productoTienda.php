...
<head>
<meta charset="UTF-8"/>
<title>Muestra Comercio Tienda cliente</title>  
...
$busqueda="SELECT * FROM registroproductos INNER JOIN insertimgproducto ON registroproductos.numRegistroproducto=insertimgproducto.numRegistroProducto INNER JOIN celular ON registroproductos.numRegistroGlobal=celular.numRegistroGlobal";
 ...
 <table class='col-12 '>
            ...
            <tr>
              <td style='width:25%;border-radius:0px 20px 0px 20px;' class='btn-secondary'><label class='label label-warning' value='id'>
            <i style='color:black;'>ID</i></label></i></td>
             ...
             <tr>
              <td style='width:25%;border-radius:0px 20px 0px 20px;' class='btn-secondary'><label class='label label-warning' value='Nit'><i style='color:black;'>EMPACADO</i></label></td>
            ...
            <tr>
              <td style='width:25%;border-radius:0px 20px 0px 20px;' class='btn-secondary'><label class='label label-warning' value='Nit'><i style='color:black;'>CANT EN UNIDADES</i></label></td>
            ...
            <tr>
              <td style='width:25%;border-radius:0px 20px 0px 20px;' class='btn-secondary'><label class='label label-warning' value='Nit'><i style='color:black;'> EMBALAJE POR</i></label></td>
            ...
            <tr>
              <td style='width:25%;border-radius:0px 20px 0px 20px;' class='btn-secondary'><label class='label label-warning' value='Nit'><i style='color:black;'>PRECIO DE VENTA</i></label></td>
            ...
            <tr>
            <td style='width:25%;border-radius:0px 20px 0px 20px;' class='btn-secondary'><label class='label label-warning' value='Usuario'><i style='color:black;'>PIDELO CONTACTO WHATSAPP</i></label></td>

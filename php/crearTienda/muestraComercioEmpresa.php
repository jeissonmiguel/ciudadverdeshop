...
$traeid=$id;
 ...
 while($row = mysqli_fetch_row($result)){
      ...
      echo "<div style='height:50px;width:100%;'><h5 class='bg-light float-left' style='padding:5px;color:black;font-size:300%'>Navegas como invitado,que esperas registrate !! </h5><a href='../Comercios/interfazcliente.php?id=".$row[6]."'><button class='btn btn-warning float-right' style='padding:5px;color:black;font-size:300%' >Volver </button></a><a href='../login/login.php'><button class='btn btn-success float-right' style='padding:5px;color:black;font-size:300%'>iniciar sesion</button></a><a href='../registrate/registrate.php'><button class='btn btn-light float-right' style='padding:5px;color:black;font-size:300%'>Registrate </button></a></div>";
        ...
        echo "<div style='height:60px;width:100%;'><h5 class='bg-light float-left' style='padding:5px;color:black;font-size:300%'> esta logueado como usuario: ". $usuario."</h5><a href='../Comercios/interfazcliente.php?id=".$row[6]."'><button class='btn btn-warning float-right' style='padding:5px;color:black;font-size:300%'>Volver </button></a></div>";     
      }}} 
...
<head>  
<meta charset="UTF-8"/>
<title>Muestra Comercio Empresa</title>
  ...
  <section style='display: inline-block;font-size:300%;padding:50px;' class='col-12 '>
   ...
   <table class='col-12 text-center'>
            ...
            <td style='width:25%;border-radius:0px 20px 0px 20px;' class='btn-light'><i><label class='label label-warning text-dark' value='Usuario'>Contacto Whatsapp</label></i></td>
             <td style='width:25%' class='btn-secondary '><i><a href='https://api.whatsapp.com/send?phone=57$row[11]' target='_blank' style='color:white'><img src='../../img/interfazusuario/whats.jpg' style='width:80px;height:50px;color:black;'>click $row[11]</a></i></td>
             </tr>
            ...
            <tr>
              ...
              <td style='width:25%;' class='btn-secondary '><i><label class='label label' value='Usuario'>".$row[6]."</label></i></td>     
            </tr>
            ...
            <tr>
              ...
              <td style='width:25%' class='btn-secondary  '><i><label class='label label-warning' value='Nit'>".$row[12]."</label></i></td>     
            </tr>
            ...
            <tr>
              ...
              <td style='width:25%;word-break: break-all;' class='btn-secondary '><i><label class='label label-warning' value='Producto'>".$row[20]. ""."/"." " .$row[21]."</label></i></td>     
            </tr>
            ...
            <tr>
              ...
              <td style='width:25%;word-break: break-all;' class='btn-secondary '><i><label class='label label-warning' value='Descripcion'>".$row[22]."</label></i></td>     
            </tr>
           ...
           <tr>
              ...
              <td style='width:25%;' class='btn-secondary '><i><label class='label label-warning' value='Id'>".$row[0]."</label></i></td>     
            </tr>
            ...
            <tr>
              ...
              <td style='width:25%;' class='btn-secondary '><i><label class='label label-warning' value='Id'>".$row[3]."</label></i></td>     
            </tr>      
           ...
           <tr>
              ...
              <td style='width:25%;word-break: break-all;' class='btn-secondary '><i><label class='label label-warning' value='Valor'>".$row[16]."</label></i></td>     
            </tr> 
             ...
             <tr>
              ...
              <td style='width:25%;padding:10px 10px 10px 10px;' class='btn-secondary '><i><a href='../Comercios/mostrarproductos.php?id=".$row[0]."'><button class='btn btn-light' style='width:50%;font-size:100%'>ingresar</button></a></i></td>                 
            </tr>
              ...
              <td style='width:25%;padding:10px 10px 10px 10px;' class='btn-secondary '><i><a href='../calificame/calificame.php?id=".$row[0]."&id1=".$row[5]."&id2=".$row[2]."'><button class='btn btn-light' style='width:50%;font-size:100%'>ingresar</button></a></i></td>                 
            </tr> 
             ...
             <tr>
              ...
              <td style='width:25%;padding:10px 10px 10px 10px;' class='btn-secondary '><i><textarea style='width:80%;height:180px;' class='label label-warning text-dark' value='Tiva'>$url</textarea></i></td>                 
            </tr> 
             ...
             <tr>
              ...
              <td style='width:25%;padding:10px 10px 10px 10px;' class='btn-secondary '><i><a href='$row[42]' target='_blank'><textarea style='width:80%;height:150px;' class='label label-warning text-dark' value='Tiva'>".$row[42]."</textarea></a></i></td>                 
            </tr>

             <tr>
              <td  colspam='2'style='width:25%;border-radius:0px 20px 0px 20px;' class='btn-light'><i><label class='label label-warning text-dark' value='Tiva'>Pagina web</i></td> 
              <td style='width:25%;padding:10px 10px 10px 10px;word-break: break-all;'  class='btn-secondary'><i><a href='$row[46]' target='_blank'><textarea style='width:80%;height:150px;' class='label label-warning text-dark' value='Tiva'>".$row[46]."</textarea></a></i></td>                 
            </tr> 
             ...
             <tr>
              ...
              <td style='width:25%;padding:10px 10px 10px 10px;' class='btn-secondary'><i><textarea style='width:80%;height:150px;' class='label label-warning text-dark' value='Tiva'>".$row[29]."</textarea></i></td>                 
            </tr>
            ...
            <tr>
              ...
              <td style='width:40%;background-color: #D3D7E3;'><i><label class='label label-warning' value='Descuento'>".$row[0]."</label></i></td>     
            </tr>
            ...
            <tr>
             ...
             <tr>
              <td style='width:40%;border-radius:0px 20px 0px 20px;' class='btn-secondary'><i><label class='label label-warning' value='Descuento' colsan=2>Precio de venta</label></i></td>
              <td style='width:40%;background-color: #D3D7E3;'><i><label class='label label-warning' value='Descuento'><i></b>$";?>
            ...
            <tr>
              ...
              <td style='width:40%;background-color: #D3D7E3;'><i><input disabled type='button' value='Proximamente' class='btn-secondary' style='font-size:200%;'></i></td>     
            </tr>
            -->";?>
          ...
          echo " 
          <tr style='padding:20px;width:50px;word-break: break-all;'>

          <td class='btn-secondary text-center' style='padding:20px;width:50%;style='color:black;' colspan='2'>  
          <label style='width:100%;color:black;background-color: #D3D7E3;' class='btn-info text-center'>Ubicación ↓ </label><br>
           $row[coordenadas]
           </td>         
            </tr>                     
              </table>";
         ...
         echo "<label style='width:100%;color:black;background-color: #D3D7E3;'class='btn-info text-center'>Comentarios ↓ </label><br>";

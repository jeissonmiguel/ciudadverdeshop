<?php
 ...
 $usuario= (isset($_SESSION['logueado'])    ? $_SESSION['logueado']    : '');
  ...
  if ($usuario == "") {
     ...
     session_destroy();
         echo "<h5 class='btn-warning'> no estas logueado que esperas registrate = )<a href='../registrate/registrate.php'></a><button class='btn btn-info'>a un click</button></h5>";
           }else{
...
<header class="">
     <div class="col-lg-2 col-sm-6 col-md-3 btn btn-info bordes bordes"><</div>
     <div class="col-lg-6 col-sm-6 col-md-3 btn btn-info bordes"><h4>Interfaz Usuario</h4></div>
     <!-- <a href="../login/login.php" class="btn btn-info letra"></a> -->
     <form action="">
     <button type="submit" onclick=this.form.action="../login/selecionperfil.php" class="col-lg-2 col-md-3 col-sm-3  btn btn-light bordes bordes btn-success"><h4>Home</button>
      <button type="submit" onclick=this.form.action="ingresarTienda.php" class="col-lg-2 col-md-3 col-sm-3 btn btn-info bordes bordes btn-info"><h4>volver</button>
     </form>
     <br>
              
     <div class="col-4 float-left">.</div>
     <div class="col-lg-2 col-md-3 col-sm-3 btn btn-info bordes bordes"><h4>Usuario:</h4></div>
     <div class="col-lg-2 col-md-3 col-sm-3 btn btn-info bordes bordes"><h4><?php echo $usuario; ?></h4></div>
     <div class="col-4 float-left">.</div>     
<?php
...
<br><br>
   <!--  <div class="col-3 float-left"><button onclick=this.form.action="" name="b1"  id="b1" class=" btn btn-info bordes bordes w-75"><h4 style="font-size:100%">Modo lista</h4></button></div>
    <div class="col-3 float-left"><button onclick=this.form.action="" name="b2"  id="b2" class=" btn btn-info bordes bordes w-75 "><h4 style="font-size:100%">Modo cliente</h4></button></div>
    <div class="col-3 float-left"><button onclick=this.form.action="" name="b3"  id="b3" class=" btn btn-info bordes bordes w-75"><h4 style="font-size:100%">Ingresar productos</h4></button></div>
    <div class="col-3 float-left"><button onclick=this.form.action="" name="b4"  id="b4" class=" btn btn-info bordes bordes w-75"><h4 style="font-size:100%">Editar datos Comercio</h4></button></div>
    <br><br> -->

<?php
 ...
 while($row = mysqli_fetch_row($result)){
            if ($id==$row[0]){
            echo "<h5 class='btn-warning letrat1'style='height:38px'>". $usuario."<a href='../Comercios/mostrarproductos.php?id=".$row[0]."'><button style='float:right;'class='btn btn-success'>Volver</button></a></h5>";}}
           // } 
...
<body class="letrat">
 ...
 <table class='col-12 '>
            ...
            <tr>
             ...
             <td style='width:40%' class='btn-success'><i><a href='https://api.whatsapp.com/send?phone=57$row[11]' target='_blank' style='color:white'><img src='../../img/interfazusuario/whats.jpg' style='width:80px;heigth:100%;'>click</a></i></td>
             </tr>
            ...
            <tr>
              ...
              <td style='width:40%' class='btn-success'><i><label class='label label-warning' value='Usuario'>".$row[6]."</label></i></td>     
            </tr>
            ...
            <tr>
              ...
              <td style='width:40%' class='btn-success'><i><label class='label label-warning' value='Nit'>".$row[11]."</label></i></td>     
            </tr>
            ...
            <tr>
              ...
              <td style='width:40%' class='btn-success'><i><label class='label label-warning' value='Producto'>".$row[19]. ""."/"." " .$row[20]."</label></i></td>     
            </tr>
            ...
            <tr>
              ...
              <td style='width:40%' class='btn-success'><i><label class='label label-warning' value='Descripcion'>".$row[21]."</label></i></td>     
            </tr>
           ...
           <tr>
              ...
              <td style='width:40%;' class='btn-success'><i><label class='label label-warning' value='Id'>".$row[0]."</label></i></td>     
            </tr>

            <tr>
              <td style='width:40%;border-radius:0px 20px 0px 20px;' class='btn-secondary'><i><label class='label label-warning' value='Rut'>Rut:</label></i></td>
              <td style='width:40%;' class='btn-success'><i><label class='label label-warning' value='Id'>".$row[3]."</label></i></td>     
            </tr>
            ...
            <tr>
              ...
              <td style='width:40%' class='btn-success'><i><label class='label label-warning' value='Valor'>".$row[15]."</label></i></td>     
            </tr>
             ...
             <tr>
              ...
              <td style='width:40%;padding:10px 10px 10px 10px;' class='btn-success'><i><a href='http://localhost/proyectos%20HTML/ciudadverdeshop/php/Comercios/mostrarproductos.php?id=".$row[0]."'><button class='btn btn-secondary' style='width:100%;'>ingresar</button></a></i></td>                 
            </tr>
             ...
             <tr>
              ...
              <td style='width:40%;padding:10px 10px 10px 10px;' class='btn-success'><i><a href='../calificame/calificame.php?id=".$row[0]."&id1=".$row[5]."&id2=".$row[2]."'><button class='btn btn-secondary' style='width:100%;'>ingresar</button></a></i></td>                 
            </tr>      
             ...
             <tr>
              ...
              <td style='width:40%;padding:10px 10px 10px 10px;' class='btn-success'><i><textarea style='width:80%;height:50px;' class='label label-warning' value='Tiva'>https://ciudadverdeshop.000webhostapp.com/php/crearTienda/muestraComercioTienda.php?id=".$row[0]."</textarea></i></td>                 
            </tr> 
            ...
            <tr>
              ...
              <td style='width:40%;padding:10px 10px 10px 10px;' class='btn-success'><i><a href='".$row[41]."' target='_blank'><textarea style='width:80%;height:50px;' class='label label-warning' value='Tiva'>".$row[41]."</textarea></a></i></td>          
            </tr> 

             <tr>
              <td  colspam='1' style='width:40%;border-radius:0px 20px 0px 20px;' class='btn-secondary'><i></td>             
      ...
      echo "<label style='width:100%;'class='btn-success text-center'>comentarios ↓</label><br>";

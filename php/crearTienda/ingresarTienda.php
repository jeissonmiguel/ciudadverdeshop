<?php
 ...
 $usuario= (isset($_SESSION['logueado'])    ? $_SESSION['logueado']    : ''); 
  if ($usuario == "") {
     ...
     echo "<h5 class='btn-warning letrat1'style='height:38px'> esta logueado como: ". $usuario."<a href='../almacenProductos/desloguearte.php'><button style='float:right;'class='btn btn-success'>Cerrar Sesión</button></a><a href='../almacenProductos/desloguearte.php'><button style='float:right;'class='btn btn-success'></button></a></h5>";
      } 
...
<body class="col-12" style="background-color: #DFFAD6; width:100%; "> 
<a href="../../index.html"><div class="padding badge badge-success btn btn-success col-6"><h3 class="letrat1"><= Volver a Ciudad Verde Shop inicio</h3></div></a>
<a href="../login/selecionperfil.php"><div class="padding badge badge-warning btn btn-warning float-right col-6"><h3 class="letrat1"><= Volver a Home</h3></div></a>
<br> 
<div  class="container-fluid">
      <marquee  loop="0" style="background:#28a745;color:white;font-size:25px;border-radius:2%;">
      <div class="col-1 float-left"></div>
       <h1 class="btn btn-success letrat1" style="font-size:150%;">Hola <?php echo $nombre1," ", $nombre2?> estos son todos tus comercios dale click para ver mas</h1></marquee>
     </div>
    
   
  <div class="padding badge badge-info btn btn-success float-right col-6" id="b2" name="b2"><h3 class="letrat1"><img src="../../img/index/body/actualizacion1/mouse.jpg" style="width: 50px; height: 35px; border-radius: 50px;"> --> Empresa</h3></div>  
<div class="padding badge badge-success btn btn-success col-6" id="b1" name="b1"><h3 class="letrat1"><img src="../../img/index/body/actualizacion1/mouse.jpg" style="width: 50px; height: 35px; border-radius: 50px;font-size: 100%;"> --> Tienda</h3></div>
     ...
     // $nombre1 = mysqli_query($conexion,$busqueda1);
           ...
           // while(($row = mysqli_fetch_row($nombre)) and($row1 = mysqli_fetch_row($nombre1)) ){
            ...
            echo" 
             ...
             <br>
            border-width: 3px;font-size: 100%;background='../crearTienda/$row[36]';'>
            ...
            <tr>                          
             ...
             <a href='MostrarTienda.php?id=". $row[0] ."'><img src='../crearTienda/$row[36]' id='imagenPrevisualizacion' style='width:100%;height:250px;'  ></a>
             <tr>
              <td style='width:40%;' class='btn-success'><i><label class='label label-success' value='Id'><i><a href='https://api.whatsapp.com/send?phone=57$row[11]' target='_blank'><img src='../../img/interfazusuario/whats.jpg' style='width:100%;heigth:1px;display:inline-block;background-size: cover;'></td>
            ...
            <tr>
              <td style='width:20%;' class='btn-success'><i><label class='label label-success' value='Usuario' style='height:200px;'>Descripcion:</label></i></td>
              <td style='width:40%' class='btn-success'><i><label class='label label-success text-capitalize' value='Usuario'><i>" .$row[28]. "</label></i></td>     
            </tr>  

             <tr>
              <td style='width:20%;' class='btn-success'><i><label class='label label-success' value='Registro'>Ingrese al comercio:</label></i></td>
              <td style='width:40%' class='btn-success'><i><label class='label label-success text-capitalize' value='Registro'><i><a href='../Comercios/mostrarproductos.php?id=". $row[0] ."'><input type='button' name='click1' value='Ingresar' class='btn btn-light text-success'></label></i></td>     
            </tr>
     ...
     $nombre = mysqli_query($conexion,$busqueda);
           ...
           // while(($row = mysqli_fetch_row($nombre)) and($row1 = mysqli_fetch_row($nombre1)) ){
            ...
            <tr>                          
             ...
             <a href='MostrarEmpresa.php?id=". $row[0] ."'><img src='../crearTienda/$row[36]' id='imagenPrevisualizacion' style='width:100%;height:250px;'></a>
             <tr>
              <td style='width:40%;' class='btn-info'><i><label class='label label-info' value='Id'><i><a href='https://api.whatsapp.com/send?phone=57$row[11]' target='_blank'><img src='../../img/interfazusuario/whats.jpg' style='width:100%;heigth:1px;display:inline-block;background-size: cover;'></td>
             ...
             <tr>
              ...
              <td style='width:40%' class='btn-info'><i><label class='label label-info text-capitalize' value='Registro'><i>" .$row[11]. "</i></label></td>     
            </tr>

             <tr>
              <td style='width:40%;text-align: center;' class='btn-info'><i><label class='label label-info text-capitalize' value='Usuario' style='height:200px;'>Descripcion:</label></i></td>
              <td style='width:40%' class='btn-info'><i><label class='label label-info text-capitalize' value='Usuario'><i>" .$row[28]. "</label></i></td>     
            </tr>                       

            <tr>
             <td style='width:20%;' class='btn-info'><i><label class='label label-info' value='Registro'>Ingrese al comercio:</label></i></td>
              <td style='width:40%' class='btn-info'><i><label class='label label-info text-capitalize' value='Registro'><i><a href='../Comercios/mostrarproductos.php?id=". $row[0] ."'><input type='button' name='click1' value='Ingresar' class='btn btn-light text-info'></label></i></td>         
            </tr>

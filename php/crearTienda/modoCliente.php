...
<section id="modocliente" name="modocliente" class="letrat"> 
...
<div id="registrotienda" name="registrotienda" > 
   ...
   <?php
    ...
    if(!empty($numregistrotienda)){  
     ...
     echo '<div id="hd3" name="hd3" class="col-12 btn btn-success border border-dark"><h2 class="letrat1 text-white" style="font-size:200%;">Estas en la Tienda <b>'; if(!empty($tienda)){ echo $tienda; } if(!empty($empresa)){ echo $empresa; } echo '</b> disfruta de sus productos</h2></div>';
...
$busqueda= "SELECT * FROM  registrotienda  INNER JOIN celular ON registrotienda.numRegistroTienda=celular.numRegistroGlobal INNER JOIN email ON registrotienda.numRegistroTienda=email.numRegistroGlobal INNER JOIN direccion ON registrotienda.numRegistroTienda=direccion.numRegistroGlobal INNER JOIN descripcion ON registrotienda.numRegistroTienda=descripcion.numRegistroGlobal INNER JOIN insertimglogo ON registrotienda.numRegistroTienda=insertimglogo.numRegistroGlobal WHERE numRegistroTienda='$numregistrotienda'";
     ...
     //        <!--<img src='../crearTienda/$row[36]' width='200px' heigth='100px'>-->
     //        <tr>
...
<div id="registroproductos" name="registroproductos" class="letrat">
  <?php  
   if(!empty($numregistroempresa)){
    if ($numregistroempresa!="") {
        echo '<div id="hd3" name="hd3" class="col-12 btn btn-info border border-dark"><h2 class="letrat1 text-white" style="font-size:200%;">Estas en la Empresa <b>'; if(!empty($tienda)){ echo $tienda; } if(!empty($empresa)){ echo $empresa; } echo '</b> disfruta de sus productos</h2></div>';
     // include ("../conexion/conexion.php");
     ...
     // $nombre1 = mysqli_query($conexion,$busqueda1);
        ...
        echo '<!--<script src="jquery-3.4.1.min.js"></script>-->';
         ...
         while($row = mysqli_fetch_row($nombre)){         
          echo "<header><div class='col-12 float-left badge badge-info'><!-- <h5>Licor</h5> -->
            <a href='../crearTienda/muestraComercioEmpresa.php?id=". $row[0] ."'><img src='../crearTienda/$row[36]' style='width:50%; height:300px;'  onmouseout='this.style.opacity=1;this.filters.alpha.opacity='100';' onmouseover='this.style.opacity=0.7;this.filters.alpha.opacity='20';></a>
          ...
          //   echo"  <!--<img src='../crearTienda/$row[36]' width='200px' heigth='100px'>-->
          //   <tr>
      ...
      $result = mysqli_query($conexion,$busqueda); 
          ...
          if(!empty($tienda)){ echo "<div class='col-12 btn btn-success border border-dark'><h2 class='letrat1 text-white' style='font-size:200%'>Productos</h2></div>"; } if(!empty($empresa)){ echo "<div class='col-12 btn btn-info border border-dark'><h2 class='letrat1 text-white' style='font-size:200%'>Productos</h2></div>"; }
  ...
  <section class='sectiontamano' style='display: inline-block;border-style: solid;
      ...
      <table class='egt bg-light text-capitalize' style='width:100%;height:100px;'>
            ...
            <tr>
              <th scope='col' class='btn-secondary'><label class='label label-warning' style= value='Id'>Descripcion:</label></th>    
              <th style='width:30%;height:150px;border-radius:0px 20px 0px 20px;'class='text-uppercase'>".$row[4]. "".""." " .$row[5]."</th>
            </tr>
           ...
           <tr>
            ...
            <tr>
              ...
              <td style='width:40%' class='btn-success'><i><a href='../crearTienda/productoTienda.php?id=". $row[2] ."&mc=mc'><input type='submit' value='ver' class='btn-success'></a></i></td>     
            </tr>         
      ...
      <table class='egt bg-light text-capitalize' style='width:100%;height:100px;'>
           ...
           <tr>
              <td style='width:40%;border-radius:0px 20px 0px 20px;' class='btn-secondary'><i><label class='label label-warning' style= value='Id'>Id:</label></i></td>
              <td style='width:40%;' class='btn-info'><i><label class='label label-warning' value='Id'>".$row[2]."</label></i></td>     
            </tr>

            <!--<tr>
              <td style='width:40%;border-radius:0px 20px 0px 20px;' class='btn-secondary'><i><label class='label label-warning' value='Registro'>Registro Comercio:</label></i></td>
              <td style='width:40%' class='btn-info'><i><label class='label label-warning' value='Registro'>".$row[1]."</label></i></td>     
            </tr>


            <tr>
              <td style='width:40%;border-radius:0px 20px 0px 20px;' class='btn-secondary'><i><label class='label label-warning' value='Usuario'>Registro Producto:</label></i></td>
              <td style='width:40%' class='btn-info'><i><label class='label label-warning' value='Usuario'>".$row[2]."</label></i></td>     
            </tr>
            -->
            ...
            <tr>
              <td style='width:40%;border-radius:0px 20px 0px 20px;' class='btn-secondary'><i><label class='label label-warning' value='Nit'>Usuario:</label></i></td>
              <td style='width:40%' class='btn-info'><i><label class='label label-warning' value='Nit'>".$row[3]."</label></i></td>     
            </tr>
            -->
            ...
            <tr>
              <td style='width:40%;border-radius:0px 20px 0px 20px;' class='btn-secondary'><i><label class='label label-warning' value='Producto'>Producto:</label></i></td>
              <td style='width:40%' class='btn-info'><i><label class='label label-warning' value='Producto'>".$row[4]."</label></i></td>     
            </tr>

            
            <tr>
              <td style='width:40%;border-radius:0px 20px 0px 20px;' class='btn-secondary'><i><label class='label label-warning' value='Descripcion'>Descripcion:</label></i></td>
              <td style='width:40%' class='btn-info'><i><label class='label label-warning' value='Descripcion'>".$row[5]."</label></i></td>     
            </tr>
             -->
            ...
            <tr>
             ...
             <tr>
              <td style='width:40%;border-radius:0px 20px 0px 20px;' class='btn-secondary'><i><label class='label label-warning' value='Iva'>Cantidad en unidades:</label></i></td>
              <td style='width:40%' class='btn-info'><i><label class='label label-warning' value='Iva'>".$row[7]."</label></i></td>     
            </tr>

            <!--
            <tr>
              <td style='width:40%;border-radius:0px 20px 0px 20px;' class='btn-secondary'><i><label class='label label-warning' value='Iva'>Valor:</label></i></td>
              <td style='width:40%' class='btn-info'><i><label class='label label-warning' value='Iva'>".$row[8]."</label></i></td>     
            </tr>

             <tr>
              <td style='width:40%;border-radius:0px 20px 0px 20px;' class='btn-secondary'><i><label class='label label-warning' value='Tiva'>iva:</label></i></td>
              <td style='width:40%' class='btn-info'><i><label class='label label-warning' value='Tiva'>".$row[9]."</label></i></td>     
            </tr>

            <tr>
              <td style='width:40%;border-radius:0px 20px 0px 20px;' class='btn-secondary'><i><label class='label label-warning' value='Descuento'>Tiva:</label></i></td>
              <td style='width:40%' class='btn-info'><i><label class='label label-warning' value='Descuento'>".$row[10]."</label></i></td>     
            </tr>

            <tr>
              <td style='width:40%;border-radius:0px 20px 0px 20px;' class='btn-secondary'><i><label class='label label-warning' value='Descuento'>Descuento:</label></i></td>
              <td style='width:40%' class='btn-info'><i><label class='label label-warning' value='Descuento'>".$row[11]."</label></i></td>     
            </tr>
            -->
            ...
            <tr>
              <td style='width:40%;border-radius:0px 20px 0px 20px;' class='btn-danger'><i><label class='label label-warning'  value='ver'> ver Producto</label></i></td>
              <td style='width:40%' class='btn-info'><i><a href='../crearTienda/productoEmpresa.php?id=". $row[2] ."&mc=mc'><input type='submit' value='ver' class='btn-info'></a></i></td>     
            </tr>         

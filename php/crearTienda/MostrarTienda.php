...
<header class="">
     ...
     <form action="">
      ...
      <button type="submit" onclick=this.form.action="ingresarTienda.php" class="col-lg-2 col-md-3 col-sm-3  btn btn-success bordes bordes btn-success"><h4>volver</button>
     </form>
     <br>

      <div class="col-4 float-left">.</div>
     <div class="col-lg-2 col-md-3 col-sm-3 btn btn-success bordes bordes"><h4>Usuario:</h4></div>
     <div class="col-lg-2 col-md-3 col-sm-3 btn btn-success bordes bordes"><h4><?php echo $usuario; ?></h4></div>
     <div class="col-4 float-left">.</div>   
<?php

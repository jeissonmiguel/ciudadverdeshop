...
<header class="">
     <div class="col-2 btn btn-success bordes letrat1 bordes"><</div>
     <div class="col-8 btn btn-success bordes letrat1"><h4>Interfaz Usuario</h4></div>
     <!-- <a href="../login/login.php" class="btn btn-success letra"></a> -->
     <form action="">
     <button type="submit" onclick=this.form.action="../login/selecionperfil.php" class="col-2 btn btn-success bordes letrat1 bordes btn-success"><h4>Home</button>
     </form>
     <br>
              
     <div class="col-4 float-left">.</div>
     <div class="col-2 btn btn-success bordes letrat1 bordes"><h4>Usuario:</h4></div>
     <div class="col-2 btn btn-success bordes letrat1 bordes"><h4><?php echo $usuario; ?></h4></div>
     <div class="col-4 float-left">.</div>     
<?php
...
<br><br>
    <div class="col-3 float-left"><button onclick=this.form.action="" name="b1"  id="b1" class=" btn btn-success bordes letrat1 bordes w-75"><h4 style="font-size:100%">Modo lista</h4></button></div>
    <div class="col-3 float-left"><button onclick=this.form.action="" name="b2"  id="b2" class=" btn btn-success bordes letrat1 bordes w-75 "><h4 style="font-size:100%">Modo cliente</h4></button></div>
    <div class="col-3 float-left"><button onclick=this.form.action="" name="b3"  id="b3" class=" btn btn-success bordes letrat1 bordes w-75"><h4 style="font-size:100%">Ingresar productos</h4></button></div>
    <div class="col-3 float-left"><button onclick=this.form.action="" name="b4"  id="b4" class=" btn btn-success bordes letrat1 bordes w-75"><h4 style="font-size:100%">Editar datos Comercio</h4></button></div>
    <br><br>

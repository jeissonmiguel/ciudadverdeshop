...
<body  style="padding:20%;zoom:100%; width:100%;height:70%;padding:20px 20px 20px 20px;word-break: break-all;"> 
...
echo'
 ...
 <button style="width:49%;padding:1%" id="boton2" name="boton2" class="badge btn btn-dark bordes">Most registro de usuario</button>
         <button style="width:49%;padding:1%" id="boton1" name="boton1" class="badge btn btn-dark bordes">Mostrar usuarios</button>          
          <button style="width:49%;padding:1%"  id="boton3" name="boton3" class="badge btn btn-dark bordes">Mostrar tiendas</button>
          <button style="width:49%;padding:1%"  id="boton4" name="boton4" class="badge btn btn-dark bordes">Mostrar empresas</button>
          <button style="width:49%;padding:1%"  id="boton5" name="boton5"  class="badge btn btn-dark bordes">Mostrar productos</button>
          <button style="width:49%;padding:1%"  id="boton11" name="boton11"  class="badge btn btn-dark bordes">Most Producto indiv</button>
  <br>

          <button style="width:49%;padding:1%" id="boton6" name="boton6" class="badge btn btn-dark bordes">Celular</button>
          <button style="width:49%;padding:1%" id="boton7" name="boton7" class="badge btn btn-dark bordes">Email</button>
          <button style="width:49%;padding:1%"  id="boton8" name="boton8" class="badge btn btn-dark bordes">Intereses</button>
          <button style="width:49%;padding:1%"  id="boton9" name="boton9" class="badge btn btn-dark bordes">Fecha de registro</button>
          <button style="width:49%;padding:1%"  id="boton10" name="boton10" class="badge btn btn-dark bordes">Direccion</button>
          <button style="width:49%;padding:1%"  id="boton14" name="boton10" class="badge btn btn-dark bordes">paginaweb</button>
          <button style="width:49%;padding:1%"  id="boton15" name="boton12"  class="badge btn btn-dark bordes">redsocial</button>
          <button style="width:49%;padding:1%"  id="boton12" name="boton12"  class="badge btn btn-dark bordes">Advance</button>

          <!-- <button  id="boton10" name="boton10"  class=" badge btn btn-success bordes w-75">Mostrar productos</button></div> -->
   </header>       
    <br><br>';
  }
    ?>

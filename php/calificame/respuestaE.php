...
if (mysqli_query($conexion,$ingresar)) 
          {     
          echo "<script>alert('comenatrio agregado correctamente');</script>"."<script type='text/javascript'>"."window.location='../crearTienda/muestraComercioEmpresa.php?id=$numRegistroGlobal'"."</script>"; 
  ...
  echo "<script>alert('ya has registrado un comentario anteriormente si tienes una queja comunicate con el administrador');</script>"."<script type='text/javascript'>"."window.location='../crearTienda/muestraComercioEmpresa.php?id=$numRegistroGlobal'"."</script>";
}
}else{
  echo "<script>alert('no te haz logueado para generar un comentario logueate, anda disfruta de sus beneficios');</script>"."<script type='text/javascript'>"."window.location='../crearTienda/muestraComercioEmpresa.php?id=$numRegistroGlobal'"."</script>";
}
}

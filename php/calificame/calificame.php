...
<label class=" badge-warning text-center" style="font-size:150%;width:100%;">Estas Calificando el comercio <?php echo $id1;?></label>
...
<?php if($id2=="registroTienda"){echo '<form  class="" action="respuesta.php?" method="post" name="en1">';}else{echo '<form  class="" action="respuestaE.php?" method="post" name="en1">';}?>
 ...
 <br>
			...
			<label class="badge badge-success col-12" style="font-size:100%;">2) la respuesta a sido rapida:</label>
	     <br>
			...
			<label class="badge badge-success col-12" style="font-size:100%">3) Volverias a comprar en este comercio :</label>
         ...
         <label class="badge badge-success col-12" style="font-size:100%;">4) Recomendarias el comercio</label>
			...
			&nbsp;&nbsp;&nbsp;
			 ...
			 <label class="badge badge-success col-12" style="font-size:100%;">5) regalame un comentario para <br>mejorar max 206 caracteres</label>

...
<body style="zoom:100%;" class="jumbotron container-fluid col-lg-5 col-xs-6 col-md-6 letrat">
	...
	<div>
		<div class="padding badge badge-success col-12"><h3 class="display-6">Ciudad Verde Shop</h3></div>
		   ...
		   <form  method="post" action="selecionperfil.php">		   
		    <br>
			<input class="trans" type="text" placeholder="Usuario" id="usuario" name="usuario" autofocus>
			<br><br>
			<input class="trans"  type="password" placeholder="Contraseña" id="contrasena" name="contrasena" pattern=".{8,}" minlength="5" maxlength="10" title="ocho digitos numericos">
			<br><br>

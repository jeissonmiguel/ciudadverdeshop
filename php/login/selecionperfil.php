	...
	<div>
	 ...
	 <br><br>
	   ...
	   <form  method="post" action="">
            ...
            <label class="padding  trans badge badge-success" style="font-size:130%">Estas logueado como usuario <b class="text-dark"><?php echo $documento?></b></label>
		    <label class="padding  trans badge badge-success" style="font-size:130%">Que quieres hacer? <b class="text-dark"><?php echo $nombre1," ", $nombre2?></b></label>

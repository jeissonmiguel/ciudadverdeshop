	...
	<div>
		<div class="padding badge badge-success col-12"><h3 class="display-6">Cambia la contraseña Generica</h3></div>
		   ...
		   <form  method="post" action="procesocambio.php">		   
			...
			<br><br>
			<input class="trans"  type="password" placeholder="Confirmar Nueva contrasena" id="confirmar" name="confirmar" required onchange="verificar();" pattern=".{8,}" minlength="5" maxlength="10">
			<br><br>

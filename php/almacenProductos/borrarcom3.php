...
include("../conexion/conexion.php");
 ...
 $busquedaidcomercio="SELECT * FROM registroproductoindividual WHERE numRegistroProductoIndividual='$id'";
...
$result1 = mysqli_query($conexion,$busquedaidcomercio1);
 while($row1 = mysqli_fetch_array($result1)){  
            $image=$row1[4];       
                            ...
                            $eliminar="DELETE FROM registroproductoindividual WHERE numRegistroProductoIndividual='$id'";
                     ...
                     $ruta="../../img/archivos/imagenesRegistroProductoIndividual/".$usuario."/".$id."/".$image;
                     unlink($ruta);
                     if(file_exists("../../img/archivos/imagenesRegistroProductoIndividual/".$usuario."/".$id)){
                      rmdir("../../img/archivos/imagenesRegistroProductoIndividual/".$usuario."/".$id);
                      }    

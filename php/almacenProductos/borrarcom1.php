...
include("../conexion/conexion.php");
 ...
 $busquedaidcomercio="SELECT * FROM registroempresa WHERE numRegistroEmpresa='$id'";
...
$result1 = mysqli_query($conexion,$busquedaidcomercio1);
 while($row1 = mysqli_fetch_array($result1)){  
            $image=$row1[4];       
                            ...
                            $eliminar="DELETE FROM registroempresa WHERE numRegistroEmpresa='$id'";
                     ...
                     $ruta="../../img/archivos/LogoEmpresa/".$usuario."/".$id."/".$image;
                     unlink($ruta);
                     if(file_exists("../../img/archivos/LogoEmpresa/".$usuario."/".$id)){
                      rmdir("../../img/archivos/LogoEmpresa/".$usuario."/".$id);
                      }    
